...
let ss2 = ['滚轮','组合','灭火','嵌顶','黑色','单色','瓷色','灰色','橘色','白色','理智','纯色','那啥','简装','连锁','仿生', '纳米', '原子', '电子','赛博', '窒息', '变态', '触手', '小众', '电动', '铁锈', '电音', '蠕动',  '虚构', '乱码', '不合格', '光滑', '酸性', '碱性',  '反常', '进化', '潮湿', '砂糖', '高潮', '变异',  '不爱说话', '废物', '失败', '幻想型', '社恐', '苦涩', '浓厚', '快乐', '强制', '中二病',  '限量版', '迷因', '堕落', '放射性', '美味','私人','印象','回忆','自然风光','方舟','吸音','皇家','枯燥','线索','色'];
